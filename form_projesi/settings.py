"""
Django settings for form_projesi project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-keydefault')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get('DEBUG', 'True') == 'True'

ALLOWED_HOSTS = ['*']  # Geliştirme için tüm hostlara izin ver, üretimde değiştirilmeli
...
ROOT_URLCONF = 'form_projesi.urls'
...
WSGI_APPLICATION = 'form_projesi.wsgi.application'
